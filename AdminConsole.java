                ...
                do {
                    ...
                    case "3": // "3.Alterar Propriedades de uma Eleição"
                        ...
                        while (true) {
                            ...
                            try {
                                check = rmis.check_eleicao_before(old_titulo);
                                break;
                        ...
                        eleicao = new Eleicao(ano_i, mes_i, dia_i, hora_i, minuto_i, ano_f, mes_f, dia_f, hora_f,
                                minuto_f, titulo, descricao, restricao, old_titulo, lista_lista_candidato, date_i,
                                date_f);
                        ...
                        try {
                            ...
                            case "1":
                                ...
                                while (true) {
                                    ...
                                    try {
                                        verify = rmis.check_eleicao_before(nome_eleicao);
                                        break;
                                ...
                                case "1":
                                    System.out
                                            .println("Vou guardar os dados de uma lista candidata do tipo Estudantes");
                                    break;
                                case "2":
                                ...
                                case "3":
                                    System.out.println(
                                            "Vou guardar os dados de uma lista candidata do tipo Funcionarios");
                                    break;
                                }
                            ...
                            case "2":
                                ...
                                while (true) {
                                    ...
                                    try {
                                        c = rmis.check_eleicao_before(nome_eleicao);
                                        break;
